...
import { ExactInputSingleParams, ExactOutputSingleParams } from "./types.js";
import { JsonRpcProvider } from "ethers";
import { Wallet } from "ethers";
import { Contract } from "ethers";
import * as dotenv from "dotenv";
import routerAbiJson from "./routerAbi.json" assert { type: "json" };
import factoryAbiJson from "./factoryAbi.json" assert { type: "json" };
import poolAbiJson from "./poolAbi.json" assert { type: "json" };

const routerAbi = routerAbiJson.abi;
const factoryAbi = factoryAbiJson.abi;
